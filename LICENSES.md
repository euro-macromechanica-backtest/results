...
| Path                      | License         | Notes |
|---------------------------|-----------------|-------|
| `/results/**`             | **CC BY-NC 4.0** | Annual summary CSVs, equity SVGs, reports, metrics|
...
| `/strategy_proof/**`      | **CC BY-NC 4.0** | Hashes/signatures/timestamps for strategy code archives (no code) |
| `/docs/**`                | **CC BY-NC 4.0**   | *documentation and other files* |
| *(not public)* detailed per-trade reports and time-indexed equity/drawdown series are not provided. |

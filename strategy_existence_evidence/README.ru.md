...
- 🗂️ **Состав:** файлы `*.sha256` (SHA-256-хэши), `*.asc` (GPG-подписи) и `*.ots` (OpenTimestamps).  
...
### 📘 Дополнительно
Публичное описание механики исполнения ордеров торгового движка см. в  
[**обзоре и методологии Euro Macromechanica (EMM) Backtest**](https://github.com/euro-macromechanica-backtest/results/blob/main/README.ru.md).
...
- ⛔ **Детальные отчёты по сделкам** (временные метки, цены) и **временные ряды капитала/просадки**, привязанные ко времени, **не предоставляются**.  

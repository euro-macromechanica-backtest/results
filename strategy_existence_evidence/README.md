...
- 🗂️ **Includes:** `*.sha256` (SHA-256 hashes), `*.asc` (GPG signatures), and `*.ots` (OpenTimestamps).  
...
### 📘 More info
A public description of the engine’s order-execution mechanics is available in the  

...
<a id="prep"></a>
## ‼️ Before You Start the Deep-Dive Audit
...
- Understand **SHA-256 (hash)**, **GPG signature**, and **OTS anchor** (files `.sha256`, `.asc`, `.ots`) and how to verify them. Details are in [`docs/INTEGRITY.md`](https://github.com/euro-macromechanica-backtest/results/blob/main/docs/INTEGRITY.md).

---

<a id="step-1"></a>
## ⓵ Step 1. Verify HistData Primary Data
...
- the **SHA-256 hash** of the cost-model table `m5_emm_cost_model_v1.0.csv` is verified and the **run-specific** cost values are checked for the corresponding mode and calendar year;
...
- **Commercial engagements and collaborations** — [COMMERCIAL.md](https://github.com/euro-macromechanica-backtest/results/blob/main/COMMERCIAL.md)

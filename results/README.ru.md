...
- **GBPUSD Cross Asset Test** – риск **1.0%** (старт капитала $100 000 каждый год и режим компаундинга на весь период со старта $100 000)
...
По запросу может быть подготовлен **holdout-период** для независимого аудита без переобучения и без изменения параметров.
...
- **Полная методология и определения метрик**: [`docs/metrics_methodology/metrics_schema.json`](https://github.com/euro-macromechanica-backtest/results/blob/main/docs/metrics_methodology/metrics_schema.json) / [`docs/metrics_methodology/metrics_schema.md`](https://github.com/euro-macromechanica-backtest/results/blob/main/docs/metrics_methodology/metrics_schema.md)
- **Модель издержек (commission, spread, slippage) M5 EMM cost model v1.0** — [`docs/cost_model/m5_emm_cost_model_v1.0.csv`](https://github.com/euro-macromechanica-backtest/results/tree/main/docs/cost_model/m5_emm_cost_model_v1.0.csv).
- **Таблица издержек (spread, slippage) по notional volume** - [/docs/cost_model/eurusd_market_order_costs_ecn_round-turn_pips_v1.0](https://github.com/euro-macromechanica-backtest/results/tree/main/docs/cost_model/eurusd_market_order_costs_ecn_round-turn_pips_v1.0.csv).
